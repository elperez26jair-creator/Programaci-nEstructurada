...
2. Configuración de usuario:
   ...
   git config --global user.email "elperez26jair@gmail.com"
   Creación de carpeta del proyecto y apertura en VS Code.
   ...
   Vinculación del repositorio remoto y subida del proyecto:
   git remote add origin https://github.com/usuario/repositorio.git
   git branch -M main
   git push -u origin main
   Prueba final (mini-ejercicio)
Este archivo confirma que el IDE, Git y GitHub fueron configurados correctamente.
